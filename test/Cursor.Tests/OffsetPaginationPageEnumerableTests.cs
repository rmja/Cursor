...
public class OffsetPaginationPageEnumerableTests
{
    ...
    public async Task EnumeratePages_FetchesAllPages()
    {
        ...
        var enumerable = new OffsetPaginationPageEnumerable<int, CursorPage<int>, int>(FetchPage);
    ...
    public async Task EnumeratePages_RespectsMaxPages()
    {
        ...
        var enumerable = new OffsetPaginationPageEnumerable<int, CursorPage<int>, int>(
            FetchPage,
            maxPages: 2
        );
